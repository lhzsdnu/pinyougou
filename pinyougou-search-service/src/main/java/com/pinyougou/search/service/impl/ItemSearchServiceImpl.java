...
public class ItemSearchServiceImpl implements ItemSearchService {
    ...
    @JmsListener(destination = "pinyougou_queue_solr")
    public void receiveQueueAdd(String text) {
    ...
    // 使用JmsListener配置消费者监听的队列，其中text是接收到的消息
    @JmsListener(destination = "pinyougou_queue_solr_delete")
    public void receiveQueueDelete(Long[] ids) {
        System.out.println("ItemDeleteListener监听接收到消息..."+ids);
        this.deleteByGoodsIds(Arrays.asList(ids));
